function [ positiveWords, negativeWords, neutralWords ] = fasterDescriptorWordSplit( Score, Text )
%decide if review is helpful or unhelpful then append review words to this
%is actually faster faster. old version got overwritten
